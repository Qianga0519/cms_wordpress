...
function university_files()
{
    ...
    if (is_home()) {
        wp_enqueue_style('phantrang-css', get_theme_file_uri('/css/Phantrang.css'));
    }
    if (is_404()) {
        wp_enqueue_style('404-css', get_theme_file_uri('/css/404.css'));
    }
    if (is_single()) {


        wp_enqueue_style('sing-css', get_theme_file_uri('/css/single.css'));

    }
    // if (is_page_template('custom-about-template.php')) {
    // }
    wp_enqueue_style('about-css', get_theme_file_uri('/css/about.css'));
    wp_enqueue_style('slider', get_theme_file_uri('/slick-slider/slick/slick.css'));
    wp_enqueue_style('slider1', get_theme_file_uri('/slick-slider/slick/slick-theme.css'));
    ...
    //slider
    wp_enqueue_script('my-script', get_theme_file_uri('/slick-slider/slick/slick.min.js'), array('jquery'), '1.0', true);
    ...
    if (is_page()) {
        ...
        wp_enqueue_script('about-js', get_theme_file_uri('/build/slide-about.js', array('query'), '1.0', true));
...
function woocommerce_header_add_to_cart_fragment($fragments)
{
    ...
    <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"
        title="<?php _e('View   cart', 'woothemes'); ?>">
...
// xoa breadcrumb trang shop
remove_action('woocommerce_before_main_content', 'woocommerce_breadcrumb', 20, 0);
//xoa so luong san pham trang shop
