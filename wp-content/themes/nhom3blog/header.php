...
<body style="padding: 0;" <?php body_class(); ?>>
                                ...
                                <?php if (class_exists("WooCommerce")): ?>
                                    <?php if (is_user_logged_in()): ?>
                                        ...
                                        <li class="Compare-icon">
                                            <a
                                                href="<?php echo wp_logout_url(get_permalink(get_option("woocommerce_myaccount_page_id"))) ?>">
                            ...
                            <ul>
                                ...
                                <li class="cart-icon"> <a href="<?php echo wc_get_cart_url(); ?>"
                                        title="<?php _e('Cart View', 'woothemes'); ?>"><span><i
                                                class="fa fa-shopping-cart"></i> <small class="cart-notification">
                                                <?php echo sprintf(
                                                    _n('%d item', WC()->cart->cart_contents_count, 'woothemes'),
